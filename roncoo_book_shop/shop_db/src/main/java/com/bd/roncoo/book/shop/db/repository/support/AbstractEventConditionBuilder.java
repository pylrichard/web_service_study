...
public abstract class AbstractEventConditionBuilder<T, C> extends AbstractConditionBuilder<T> {
     ...
     * 向查询中添加包含(like)条件
     *
     * @param field 指出查询条件的值从condition对象的哪个字段获取，并且指出要向哪个字段添加包含(like)条件
     */
     ...
     * 向查询中添加包含(like)条件
     *
     * @param field  指出查询条件的值从condition对象的哪个字段获取
     ...
     * 向查询中添加等于(=)条件
     *
     * @param field 指出查询条件的值从condition对象的哪个字段获取，并且指出要向哪个字段添加条件
     */
     ...
     *
     * @param field  指出查询条件的值从condition对象的哪个字段获取
     * @param column 指出要向哪个字段添加条件，即column = field
     */
