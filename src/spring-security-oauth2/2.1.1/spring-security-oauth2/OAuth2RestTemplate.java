...
public class OAuth2RestTemplate extends RestTemplate implements OAuth2RestOperations {
	 ...
	 */
	//OAuth2ClientAuthenticationProcessingFilter.attemptAuthentication中调用
	public OAuth2AccessToken getAccessToken() throws UserRedirectRequiredException {
		...
		if (accessToken == null || accessToken.isExpired()) {
			...
			//捕获AuthorizationCodeAccessTokenProvider.getRedirectForAuthorization抛出的异常
				...
				//继续向上层抛出异常，在OAuth2ClientContextFilter.doFilter中被捕获
				throw e;
			}
		}
		return accessToken;
	...
	protected OAuth2AccessToken acquireAccessToken(OAuth2ClientContext oauth2Context)
		...
		//调用AuthorizationCodeAccessTokenProvider.obtainAccessToken
